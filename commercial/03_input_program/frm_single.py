...
class Ui_frm_single(object):
    def setupUi(self, frm_single):
        ...
        self.btn_refresh = QtWidgets.QPushButton(frm_single)
        ...
        self.btn_refresh.setMinimumSize(QtCore.QSize(80, 27))
        ...
        frm_single.setTabOrder(self.cb_length_class, self.btn_refresh)
        frm_single.setTabOrder(self.btn_refresh, self.tv_single)
    ...
    def retranslateUi(self, frm_single):
        ...
        self.btn_refresh.setText(_translate("frm_single", "Refresh"))
