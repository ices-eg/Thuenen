...
class dataBaseConnection:
    ...
    def readEu_registerTable(self):
        self.cursor.execute("SELECT * FROM com_new_final.eu_register;")
...
def checkingRangeTRIP(year, trip_number, eunr, vessel_name, vessel_sign, start_date, end_date, start_loc, end_loc, observer, trip_type):
    '''
    ...
    dataTRIP.input(year, trip_number, eunr, vessel_name, vessel_sign, start_date, end_date, start_loc, end_loc, observer, trip_type)
